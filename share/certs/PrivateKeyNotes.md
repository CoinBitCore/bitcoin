...
unlocked to sign the Coinbit-Qt.app bundle.
...
allowing somebody to distribute a Coinbit-Qt.app or coinbit-qt-setup.exe with a valid
...
that the coinbit-qt.exe file inside the installer had not been tampered with.

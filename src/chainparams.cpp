...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000002d5a05ff9b9980882");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0000000000000007887b050ad57741ad5b97eceb24239fbe4e93bf944df5bc8d"); //31685
        ...
        vSeeds.emplace_back("85.25.119.154", false);
        vSeeds.emplace_back("94.130.236.187", false);
        vSeeds.emplace_back("167.99.38.197", false);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.coinbit.jonasschnelli.ch", true);
        vSeeds.emplace_back("seed.tCTB.petertodd.org", true);
